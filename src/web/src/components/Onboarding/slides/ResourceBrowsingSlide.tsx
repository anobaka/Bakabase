...
const ResourceBrowsingSlide = () => {
  const { t } = useTranslation();

  const features = [
    {
      icon: <AiOutlineFilter className="text-xl" />,
      text: t("onboarding.resourceBrowsing.point1"),
    },
    {
      icon: <AiOutlineUnorderedList className="text-xl" />,
      text: t("onboarding.resourceBrowsing.point2"),
    },
    {
      icon: <AiOutlineAppstore className="text-xl" />,
      text: t("onboarding.resourceBrowsing.point3"),
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center p-8 min-h-[400px]">
      ...
      <h2 className="text-2xl font-bold mb-2">{t("onboarding.resourceBrowsing.title")}</h2>

      <p className="text-default-500 text-center mb-6 max-w-md">
        {t("onboarding.resourceBrowsing.subtitle")}
      </p>
...
export default ResourceBrowsingSlide;
