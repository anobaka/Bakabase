import type { HelpConceptNavItem } from "../../types";

export const multiDeviceConcepts: HelpConceptNavItem[] = [
  { id: "sharing", labelKey: "helpCenter.multiDevice.concept.sharing.name" },
