...
export interface components {
  schemas: {
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.EnhancementRecordStatus":
      | 1
      | 2;
    /**
     * Format: int32
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.InitializationContentType":
      | 1
      | 2;
    /**
     * Format: int32
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.MediaLibraryTemplateAdditionalItem":
      | 0
      | 1;
    /**
     * Format: int32
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.MediaLibraryV2AdditionalItem":
      | 0
      | 1;
    /**
     * Format: int32
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.PathPropertyExtractorBasePathType":
      | 1
      | 2;
    /**
     * Format: int32
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.PropertyType":
      | 1
      | 2
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.PropertyValueScope":
      | 0
      | 1
      | 1000
      | 1001
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.ReservedProperty":
      | 12
      | 13
      | 22;
    /**
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.SearchOperation":
      | 1
      | 2
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.SpecialTextType":
      | 1
      | 3
      | 4
      | 6
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.Domain.Constants.StandardValueType":
      | 1
      | 2
      | 3
      | 4
    ...
    "Bakabase.Abstractions.Models.Domain.MediaLibrary": {
      ...
      fileSystemInformation?: {
        [
          key: string
        ]: components["schemas"]["Bakabase.InsideWorld.Models.Models.Aos.MediaLibraryFileSystemInformation"];
      };
    ...
    "Bakabase.Abstractions.Models.Domain.PathConfigurationTestResult": {
      ...
      customPropertyMap: {
        [
          key: string
        ]: components["schemas"]["Bakabase.Abstractions.Models.Domain.CustomProperty"];
      };
    };
    ...
    "Bakabase.Abstractions.Models.Domain.Resource": {
      ...
      properties?: {
        [key: string]: {
          [
            key: string
          ]: components["schemas"]["Bakabase.Abstractions.Models.Domain.Resource+Property"];
        };
      };
    ...
    "Bakabase.Abstractions.Models.Input.MediaLibraryTemplateImportInputModel": {
      ...
      customPropertyConversionsMap?: {
        [
          key: string
        ]: components["schemas"]["Bakabase.Abstractions.Models.Input.MediaLibraryTemplateImportInputModel+TCustomPropertyConversion"];
      };
      extensionGroupConversionsMap?: {
        [
          key: string
        ]: components["schemas"]["Bakabase.Abstractions.Models.Input.MediaLibraryTemplateImportInputModel+TExtensionGroupConversion"];
      };
     ...
     * @enum {integer}
     */
    "Bakabase.Abstractions.Models.View.Constants.CategoryResourceDisplayNameSegmentType":
      | 1
      | 2
      | 3
      | 4;
    ...
    "Bakabase.InsideWorld.Business.Components.Configurations.Models.Domain.ResourceOptions+SynchronizationCategoryOptions": {
      ...
      enhancerOptionsMap?: {
        [
          key: string
        ]: components["schemas"]["Bakabase.InsideWorld.Business.Components.Configurations.Models.Domain.ResourceOptions+SynchronizationEnhancerOptions"];
      };
      mediaLibraryOptionsMap?: {
        [
          key: string
        ]: components["schemas"]["Bakabase.InsideWorld.Business.Components.Configurations.Models.Domain.ResourceOptions+SynchronizationMediaLibraryOptions"];
      };
    };
    ...
    "Bakabase.InsideWorld.Business.Components.Configurations.Models.Domain.ResourceOptions+SynchronizationOptionsModel": {
      ...
      categoryOptionsMap?: {
        [
          key: string
        ]: components["schemas"]["Bakabase.InsideWorld.Business.Components.Configurations.Models.Domain.ResourceOptions+SynchronizationCategoryOptions"];
      };
      enhancerOptionsMap?: {
        [
          key: string
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.Downloader.Models.Domain.Constants.DownloadTaskAction":
      | 1
      | 2
      | 3
      | 4;
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.Downloader.Models.Domain.Constants.DownloadTaskActionOnConflict":
      | 0
      | 1
      | 2;
    /**
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.Downloader.Models.Domain.Constants.DownloadTaskDtoStatus":
      | 100
      | 200
      | 300
      | 400
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.Downloader.Models.Domain.Constants.DownloadTaskStatus":
      | 100
      | 200
      | 300
      | 400;
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.FileExplorer.IwFsType":
      | 0
      | 100
      | 200
      | 300
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.FileNameModifier.Models.FileNameModifierCaseType":
      | 1
      | 2
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.FileNameModifier.Models.FileNameModifierFileNameTarget":
      | 1
      | 2
      | 3
      | 4;
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.FileNameModifier.Models.FileNameModifierOperationType":
      | 1
      | 2
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.FileNameModifier.Models.FileNameModifierPosition":
      | 1
      | 2
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Business.Components.Tampermonkey.Models.Constants.TampermonkeyScript":
      | 1
      | 2;
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.AdditionalCoverDiscoveringSource":
      | 1
      | 2;
    /**
     * Format: int32
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.AdditionalItems.CategoryAdditionalItem":
      | 0
      | 1
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.AdditionalItems.ComponentDescriptorAdditionalItem":
      | 0
      | 1;
    /**
     * Format: int32
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.AdditionalItems.CustomPropertyAdditionalItem":
      | 0
      | 1
      | 2;
    /**
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.AdditionalItems.MediaLibraryAdditionalItem":
      | 0
      | 1
      | 2
      | 4;
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.AdditionalItems.ResourceAdditionalItem":
      | 0
      | 64
      | 128
      | 160
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.Aos.ResourceSearchSortableProperty":
      | 1
      | 2
      | 3
      | 6
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.ComponentDescriptorType":
      | 0
      | 1
      | 2
      | 3;
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.ExHentaiDownloadTaskType":
      | 1
      | 2
      | 3
      | 4;
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.MediaLibraryFileSystemError":
      | 1
      | 2
      | 3;
    /**
     ...
     * @enum {integer}
     */
    "Bakabase.InsideWorld.Models.Constants.ResourceDisplayContent":
      | 1
      | 2
      | 4
      | 7;
     ...
     * @enum {integer}
     */
    "Bakabase.Modules.Enhancer.Abstractions.Models.Domain.Constants.EnhancementAdditionalItem":
      | 0
      | 1;
     ...
     * @enum {integer}
     */
    "Bakabase.Modules.Enhancer.Models.Domain.Constants.EnhancerId":
      | 1
      | 2
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.Modules.Presets.Abstractions.Models.Constants.PresetProperty":
      | 1
      | 2
      | 3
      | 4
     ...
     * @enum {integer}
     */
    "Bakabase.Modules.Presets.Abstractions.Models.Constants.PresetResourceType":
      | 1000
      | 1001
      | 1002
      | 1003
    ...
    "Bakabase.Modules.Presets.Abstractions.Models.MediaLibraryTemplatePresetDataPool": {
      ...
      resourceTypePresetPropertyIds: {
        [
          key: string
        ]: components["schemas"]["Bakabase.Modules.Presets.Abstractions.Models.Constants.PresetProperty"][];
      };
      resourceTypeEnhancerIds: {
        [
          key: string
        ]: components["schemas"]["Bakabase.Modules.Enhancer.Models.Domain.Constants.EnhancerId"][];
      };
    };
     ...
     * @enum {integer}
     */
    "Bakabase.Modules.StandardValue.Abstractions.Models.Domain.Constants.StandardValueConversionRule":
      | 1
      | 2
      | 4
      | 8
    ...
    "Bootstrap.Models.ResponseModels.SingletonResponse`1[System.Collections.Generic.Dictionary`2[System.Int32,System.Collections.Generic.Dictionary`2[System.Int32,System.Collections.Generic.List`1[Bakabase.Modules.StandardValue.Models.View.StandardValueConversionRuleViewModel]]]]": {
      ...
      data?: {
        [key: string]: {
          [
            key: string
          ]: components["schemas"]["Bakabase.Modules.StandardValue.Models.View.StandardValueConversionRuleViewModel"][];
        } | null;
      };
    };
    "Bootstrap.Models.ResponseModels.SingletonResponse`1[System.Collections.Generic.Dictionary`2[System.Int32,System.Collections.Generic.List`1[Bakabase.Abstractions.Models.Domain.SpecialText]]]": {
      ...
      data?: {
        [key: string]:
          | components["schemas"]["Bakabase.Abstractions.Models.Domain.SpecialText"][]
          | null;
      };
    };
    "Bootstrap.Models.ResponseModels.SingletonResponse`1[System.Collections.Generic.Dictionary`2[System.String,Bakabase.InsideWorld.Models.Constants.MediaType]]": {
      ...
      data?: {
        [
          key: string
        ]: components["schemas"]["Bakabase.InsideWorld.Models.Constants.MediaType"];
      };
    };
