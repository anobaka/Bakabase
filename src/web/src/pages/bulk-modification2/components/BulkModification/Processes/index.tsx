...
import ProcessModal from "@/pages/bulk-modification2/components/BulkModification/ProcessModal";
...
export default ({ processes: propsProcesses, onChange, variables }: Props) => {
  ...
  const [processes, setProcesses] = useState<BulkModificationProcess[]>(
    propsProcesses ?? [],
  );
