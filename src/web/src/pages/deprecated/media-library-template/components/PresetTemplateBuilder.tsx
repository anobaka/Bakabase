...
import type { PresetProperty } from "@/sdk/constants.ts";
...
type Form = Omit<
  ...
  "layeredProperties"
> & { layeredProperties?: (PresetProperty | undefined)[] };
...
const PresetTemplateBuilder = ({ onDestroyed, onSubmitted }: Props) => {
  ...
  return (
    <Modal
      ...
      onOk={async () => {
        const r = await BApi.mediaLibraryTemplate.addMediaLibraryTemplateFromPresetBuilder(
          // @ts-ignore
          validForm!,
        );
