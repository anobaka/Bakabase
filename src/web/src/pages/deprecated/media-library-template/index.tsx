...
import ImportModal from "@/pages/deprecated/media-library-template/components/ImportModal.tsx";
import AddModal from "@/pages/deprecated/media-library-template/components/AddModal.tsx";
        ...
        <div className={"flex items-center gap-2"}>
          ...
          {templates.length > 0 ? (
            expandedTemplateIds.length < templates.length ? (
              ...
              <Button color={"default"} size={"sm"} onPress={() => setExpandedTemplateIds([])}>
                  ...
                  title={
                    <div className={"flex items-center justify-between"}>
                      <div className={"flex items-center gap-1"}>
                        ...
                        {tpl.author && <div className={"opacity-60"}>{tpl.author}</div>}
                        {tpl.description && (
                          <Tooltip content={tpl.description} placement={"bottom"}>
