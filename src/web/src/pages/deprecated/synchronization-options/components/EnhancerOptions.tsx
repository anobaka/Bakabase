...
import BooleanOptions from "@/pages/deprecated/synchronization-options/components/BooleanOptions";
...
const EnhancerOptions = ({ enhancer, options, onChange, subject, isSecondary }: Props) => {
