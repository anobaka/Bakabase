...
import GlobalOptions from "@/pages/deprecated/synchronization-options/components/GlobalOptions";
import CategoryOptions from "@/pages/deprecated/synchronization-options/components/CategoryOptions";
import MediaLibraryOptions from "@/pages/deprecated/synchronization-options/components/MediaLibraryOptions";
...
const SynchronizationOptionsPage = () => {
  ...
  useEffect(() => {
    setOptions(
      synchronizationOptions ? JSON.parse(JSON.stringify(synchronizationOptions)) : undefined,
    );
  }, [synchronizationOptions]);
