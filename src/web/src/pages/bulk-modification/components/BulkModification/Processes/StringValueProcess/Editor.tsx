...
import DirectionSelector from "@/pages/bulk-modification/components/BulkModification/DirectionSelector";
...
const Editor = ({
  ...
  const [operation, setOperation] = useState<BulkModificationStringProcessOperation>(
    propsOperation ?? BulkModificationStringProcessOperation.SetWithFixedValue,
  );
          ...
          comp: (
            <div className={"flex items-center gap-1 whitespace-nowrap"}>
              ...
              >
                ...
                <NumberInput
                  className={"w-auto"}
                  placeholder={t<string>("bulkModification.label.startsFromZero")}
                  style={{ width: 100 }}
                  value={options.index}
          ...
          comp: (
            <div className={"flex items-center gap-1 whitespace-nowrap"}>
              <Trans i18nKey={"BulkModification.Processor.Editor.Operation.Replace"}>
                ...
                Replace&nbsp;
                {/* 1 */}
                <Input value={options.find} onValueChange={(find) => changeOptions({ find })} />
                {/* 2 */}
                &nbsp;with&nbsp;
                {/* 3 */}
                {renderValueCell()}
