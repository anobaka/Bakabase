...
describe("StringValueProcess validate", () => {
  describe("Delete operation", () => {
    ...
    it("should return undefined even with options for Delete operation", () => {
      const result = validate(BulkModificationStringProcessOperation.Delete, {
  ...
  describe("RemoveFromAnyPosition operation", () => {
    it("should return error when options is undefined", () => {
      const result = validate(
        BulkModificationStringProcessOperation.RemoveFromAnyPosition,
        undefined,
      );
    ...
    it("should return error when count is missing", () => {
      const result = validate(BulkModificationStringProcessOperation.RemoveFromAnyPosition, {
        index: 0,
      });
  ...
  describe("ReplaceFromAnyPosition operation", () => {
    it("should return error when options is undefined", () => {
      const result = validate(
        BulkModificationStringProcessOperation.ReplaceFromAnyPosition,
        undefined,
      );
