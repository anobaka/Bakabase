...
{
    [TestClass]
    public class JavbusTests
    {
        // Integration tests — hit live Javbus. Ignored by default; remove [Ignore] to
        ...
        [DataRow("SSIS-001")]
        [DataRow("PRED-100")]
        [Ignore("Manual integration test against live Javbus.")]
        ...
        internal static void AssertParsedFieldsAreNotDuplicated(JavbusVideoDetail detail, string number)
        {
        ...
        private static JavbusClient BuildClient()
        {
