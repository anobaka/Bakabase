...
/// <c>appsettings.json</c> carries live project ids and DSNs, and anonymous tracking is on by
/// default; a fixture serves the production frontend, which reads both from
/// <c>/app/analytics-info</c> and starts Clarity, GA4, PostHog and Sentry with them.
/// </summary>
static class FixtureAnalytics
{
    /// <summary>What the Service reads, whether or not a shipped file sets it.</summary>
    private static readonly string[] Keys =
    [
        "Analytics:Clarity:ProjectId", "Analytics:Ga4:MeasurementId", "Analytics:Sentry:FrontendDsn",
        "Analytics:Sentry:BackendDsn", "Analytics:PostHog:ApiKey", "Analytics:PostHog:ApiHost"
    ];
