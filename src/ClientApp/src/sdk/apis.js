...
/**
 * 
 * request: GetResourceSearchKeywordRecommendation
 * url: GetResourceSearchKeywordRecommendationURL
 * method: GetResourceSearchKeywordRecommendation_TYPE
 * raw_url: GetResourceSearchKeywordRecommendation_RAW_URL
 * @param keyword - 
 * @param maxCount - 
 */
export const GetResourceSearchKeywordRecommendation = function(parameters = {}) {
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  const config = parameters.$config
...
export const GetResourceSearchKeywordRecommendation_RAW_URL = function() {
  return '/resource/search/keyword-recommendation'
}
export const GetResourceSearchKeywordRecommendation_TYPE = function() {
  return 'get'
}
export const GetResourceSearchKeywordRecommendationURL = function(parameters = {}) {
  let queryParameters = {}
  const domain = parameters.$domain ? parameters.$domain : getDomain()
  let path = '/resource/search/keyword-recommendation'
  if (parameters['keyword'] !== undefined) {
