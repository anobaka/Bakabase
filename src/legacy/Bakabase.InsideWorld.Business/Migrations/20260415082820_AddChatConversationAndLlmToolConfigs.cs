...
{
    /// <inheritdoc />
    public partial class AddChatConversationAndLlmToolConfigs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LlmToolConfigs", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatConversations_IsArchived",
                table: "ChatConversations",
                column: "IsArchived");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LlmToolConfigs_ToolName",
                table: "LlmToolConfigs",
                column: "ToolName",
                unique: true);
        }
