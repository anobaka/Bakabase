...
namespace Bakabase.InsideWorld.Business.Extensions
{
    public class ResourceUtils
    {
            ...
            string template, Dictionary<string, string?> propertyReplacements, (string Left, string Right)[] wrappers)
        {
            ...
            IEnumerable<ResourceDisplayNameViewModel.Segment> SplitIntoSegments(string tpl, int startIdx,
                int endIdx)
            {
                var tmpSegments = new List<ResourceDisplayNameViewModel.Segment>();
                ...
                if (closestWrapperPair == default)
                {
                    ...
                    if (find == default)
                    {
                        ...
                        tmpSegments.Add(new ResourceDisplayNameViewModel.Segment
                        {
