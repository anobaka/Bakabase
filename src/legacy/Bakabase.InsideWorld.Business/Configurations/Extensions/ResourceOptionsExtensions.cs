...
public static class ResourceOptionsExtensions
{
    ...
    public static bool ShouldBeDeletedSinceFileNotFound(this Resource fileNotFoundResource, SynchronizationOptionsModel? options)
    {
        if (options == null)
        {
            return false;
        ...
        var mo = co?.MediaLibraryOptionsMap?.GetValueOrDefault(fileNotFoundResource.MediaLibraryId);
        return mo?.DeleteResourcesWithUnknownPath ??
               co?.DeleteResourcesWithUnknownPath ?? options.DeleteResourcesWithUnknownPath ?? false;
    }
    public static bool ShouldBeDeletedSinceUnknown(this Resource fileNotFoundResource, SynchronizationOptionsModel? options)
    {
        return options?.DeleteResourcesWithUnknownMediaLibrary ?? false;
    }

    public static int[]? GetIdsOfEnhancersShouldBeReApplied(this Resource resource, SynchronizationOptionsModel? options)
    {
        if (options == null)
        {
            return null;
        ...
        var mo = co?.MediaLibraryOptionsMap?.GetValueOrDefault(resource.MediaLibraryId);
    ...
    public static int[]? GetIdsOfEnhancersShouldBeReEnhanced(this Resource resource, SynchronizationOptionsModel? options)
    {
        if (options == null)
        {
            return null;
