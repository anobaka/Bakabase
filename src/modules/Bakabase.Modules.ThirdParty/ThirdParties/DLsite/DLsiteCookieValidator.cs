...
public class DLsiteCookieValidator(IHttpClientFactory httpClientFactory, IBakabaseLocalizer localizer)
    : AbstractCookieValidator(httpClientFactory, localizer)
{
    public override CookieValidatorTarget Target => CookieValidatorTarget.DLsite;
    protected override string Url => "https://www.dlsite.com/home/mypage";
